...
using Foundation;
using UIKit;
using Xamarin.Core.Standard.Infrastructure.Settings;
using XamarinForms.Core.iOS.Infrastructure.Settings;

[assembly:Xamarin.Forms.Dependency(typeof(SettingsImplementation))] 
namespace XamarinForms.Core.iOS.Infrastructure.Settings
{
