using System;
using XamarinForms.iOS.Controls.Toast.Extensions;

namespace XamarinForms.iOS.Controls.Toast.ToastViews;
...
public class BaseToastView : UIView
{
    ...
    protected virtual void ConstrainInParent()
    {
        ...
        NSLayoutConstraint.ActivateConstraints(new[] { LeadingContraint, TrailingContraint, CenterXContraint });
    }
