...
namespace Xamarin.Core.Standard.Infrastructure.InAppBilling
{
	...
	/// </summary>
	public sealed class InAppBillingProduct
    {
        /// <summary>
        /// Name of the product
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="T:Xamarin.Core.Standard.Infrastructure.InAppBilling.InAppBillingProduct"/>
